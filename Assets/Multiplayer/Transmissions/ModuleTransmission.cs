...
namespace Core.Multiplayer.Transmissions
{
    ...
    public class ModuleTransmission : Transmission
    {
        ...
        /// The ID module
        /// </summary>
        public ushort ModuleID { get => Helper.GetUshort(0, 1, Stream); set => Helper.SetUshort(value, 0, 1, Stream); }
        ...
        public ModuleTransmission(ushort ID, ArraySegment<byte> data) : base((ushort)TransmissionType.Module, (ushort)(data.Count + HEADERSIZE))
        {
